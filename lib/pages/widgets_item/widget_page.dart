...
import 'package:flutter_fly/widgets/az_list/as_listview.dart';
...
class _WidgetPageState extends State<WidgetPage> {
  List<WidgetInfoSuspension> _widgetList = [];
    ...
    return Column(
      children: <Widget>[
        Expanded(
            ...
            child: AzListView(
              data: _widgetList,
              itemBuilder: (context, model) => _buildListItem(model as WidgetInfoSuspension),
